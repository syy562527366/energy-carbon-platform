      ...
      <div className="ml-[260px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
              ...
              <div className="flex items-center gap-6">
                <div key={summary ? 'energy-donut' : 'empty'} className="w-[140px] h-[140px] flex-shrink-0">
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
              ...
              <div className="flex items-center gap-6">
                <div key={summary ? 'carbon-donut' : 'empty'} className="w-[140px] h-[140px] flex-shrink-0">
        ...
        <div className="px-8 pb-4">
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-4">
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
              ...
              <div key={monthlyExecution.filter(m => m.energyActual > 0).length > 0 ? 'line1' : 'empty'} className="h-[260px]">
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
              ...
              <div key={categoryBreakdown.length > 0 ? 'bar' : 'empty'} className="h-[260px]">
        ...
        <div className="px-8 pb-8">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
            ...
            <div key={forecast.length > 0 ? 'forecast' : 'empty'} className="h-[260px]">
              {forecast.length > 0 ? (
