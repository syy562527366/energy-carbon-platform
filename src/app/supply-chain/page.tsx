    ...
    <div className="px-8 pb-4">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-4">
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
          ...
          <div className="h-[240px] flex items-center justify-center">{data?.emissionByCategory?.length ? <Doughnut data={cd} options={donutOpts} /> : <span className="text-slate-400">...</span>}</div>
